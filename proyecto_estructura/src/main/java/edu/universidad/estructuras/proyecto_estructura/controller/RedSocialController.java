...
public class RedSocialController {
    ...
    private void configurarTablas() {
        ...
        colSeguidosAcciones.setCellFactory(param -> new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                if (empty) {
                    ...
                    // Agregar btnVerPerfil a los HBox existentes
                    HBox hbox = new HBox(5, btnSeguir/btnDejarDeSeguir, btnVerPerfil);
        ...
        // Configurar tabla de sugerencias
        ...
        colBusquedaAcciones.setCellFactory(param -> new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                if (empty) {
                    ...
                    Usuario usuario = getTableView().getItems().get(getIndex());
                    Button boton = usuarioService.estaSiguiendo(usuarioActual.getUsername(), usuario.getUsername())
