...
public class MainController {
    ...
    private void handleBuscar() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/edu/universidad/estructuras/proyecto_estructura/busqueda.fxml"));
            Parent root = loader.load();

            Stage stage = (Stage) btnBuscar.getScene().getWindow();
            Scene scene = new Scene(root, 1200, 800);
            stage.setScene(scene);
            stage.setTitle("SyncUp - Búsqueda Avanzada");
        } catch (IOException e) {
            e.printStackTrace();
            mostrarError("Error al cargar búsqueda: " + e.getMessage());
        }
    }
    ...
    private void handleDescubrir() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/edu/universidad/estructuras/proyecto_estructura/descubrimiento.fxml"));
            Parent root = loader.load();

            Stage stage = (Stage) btnDescubrir.getScene().getWindow();
            Scene scene = new Scene(root, 1200, 900);
            stage.setScene(scene);
            stage.setTitle("SyncUp - Descubrir Música");
        } catch (IOException e) {
            e.printStackTrace();
            mostrarError("Error al cargar descubrimiento: " + e.getMessage());
        }
    }
    ...
    private void handleMisFavoritos() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/edu/universidad/estructuras/proyecto_estructura/favoritos.fxml"));  // ✅ RUTA ABSOLUTA - CORRECTO
            Parent root = loader.load();

            Stage stage = (Stage) btnMisFavoritos.getScene().getWindow();
            Scene scene = new Scene(root, 1000, 700);
            stage.setScene(scene);
            stage.setTitle("SyncUp - Mis Favoritos");
        } catch (IOException e) {
            e.printStackTrace();
            mostrarError("Error al cargar favoritos: " + e.getMessage());
        }
    }

    // Agregar nuevo botón para playlists
    @FXML
    private void handlePlaylists() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/edu/universidad/estructuras/proyecto_estructura/playlist.fxml"));
            Parent root = loader.load();

            Stage stage = (Stage) btnPlaylists.getScene().getWindow();
            Scene scene = new Scene(root, 1200, 700);
            stage.setScene(scene);
            stage.setTitle("SyncUp - Mis Playlists");
        } catch (IOException e) {
            e.printStackTrace();
            mostrarError("Error al cargar playlists: " + e.getMessage());
        }
    }
    @FXML
    private void handleRedSocial() {
        try {
            ...
            Stage stage = (Stage) btnRedSocial.getScene().getWindow();
            Scene scene = new Scene(root, 1200, 900);
            stage.setScene(scene);
            stage.setTitle("SyncUp - Red Social");
        } catch (IOException e) {
            e.printStackTrace();
            mostrarError("Error al cargar red social: " + e.getMessage());
        }
    }
    ...
    private void handleDescubrimientoSemanal() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/edu/universidad/estructuras/proyecto_estructura/descubrimiento-semanal.fxml"));
            Parent root = loader.load();

            Stage stage = (Stage) btnDescubrimientoSemanal.getScene().getWindow();
            Scene scene = new Scene(root, 1200, 900);
            stage.setScene(scene);
            stage.setTitle("SyncUp - Descubrimiento Semanal");
        } catch (IOException e) {
            e.printStackTrace();
            mostrarError("Error al cargar Descubrimiento Semanal: " + e.getMessage());
        }
    }
}