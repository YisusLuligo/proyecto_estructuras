...
/**
 * Clase principal de la aplicación MusicApp
 *
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            System.out.println("\n╔════════════════════════════════════════╗");
            System.out.println("║   MusicApp - Sistema de Música          ║");
            System.out.println("╚════════════════════════════════════════╝\n");
            ...
            // Configurar stage
            primaryStage.setTitle("MusicApp - Motor de Recomendaciones Musicales");
